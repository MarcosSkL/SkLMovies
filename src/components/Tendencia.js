...
export const Tendencia = () => {
  return (
    <div className='pr-4 text-center custom:text-left tracking-[-0,05em] custom:tracking-normal'>
      ...
      <p className='text-white  min-w-[300px] max-w-[300px] custom:max-w-[380px] custom:mx-0 mx-auto text-sm custom:text-base'>As Series mais vista das Plataformas de Streming, nao perca!</p>
      <Link href='/series'>
